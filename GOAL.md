# ask-honeybadger — Honeybadger — error tracking via the Honeybadger API

## Purpose

Service context gem for Honeybadger. Provides curated context and helpers
so AI agents can read, search, and analyze errors from Honeybadger.
...
Auth via Ask::Auth.resolve(:honeybadger_token) — get your token from https://app.honeybadger.io/users/edit
